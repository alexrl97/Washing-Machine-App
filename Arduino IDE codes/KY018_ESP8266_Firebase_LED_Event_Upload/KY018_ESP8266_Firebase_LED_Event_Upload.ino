...
This code reads data from the KY-018 and uses the WIFI function of the ESP 8266
to upload a event to the database whenever the LED the KY-018 is adjusted to gets turned on
*/
